...
const capabilities = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
        <path
          d="M12 3C7 3 3 6.5 3 11c0 2.5 1.2 4.7 3 6.2V21l3.5-2c.8.2 1.6.3 2.5.3 5 0 9-3.5 9-8s-4-8-9-8z"
          stroke="#2563eb"
          strokeWidth="1.5"
        />
      </svg>
...
export default function Solution() {
  ...
  return (
    <section
      id="solution"
      className="overflow-hidden px-6 py-24 md:py-32 bg-white"
      ref={ref}
    >
        ...
        <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
          ...
          >
            ...
            <div className="relative flex h-full min-h-[388px] items-center justify-center">
              ...
              <span
                className="pulse-line absolute right-[17%] top-[38%] h-px w-[28%] bg-gradient-to-r from-sky-300 via-accent to-white/0"
                style={{ animationDelay: "0.4s" }}
              />
              <span
                className="pulse-line absolute bottom-[31%] left-[20%] h-px w-[26%] bg-gradient-to-r from-white/0 via-accent to-sky-300"
                style={{ animationDelay: "0.8s" }}
              />
              <span
                className="pulse-line absolute bottom-[35%] right-[18%] h-px w-[27%] bg-gradient-to-r from-sky-300 via-accent to-white/0"
